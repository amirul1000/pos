...
<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			?>
                ...
                <li class="start"><a href="../profile/index.php?cmd=list"><i class="icon-rocket"></i>Profile</a></li>
                <?php
                ...
                <li class="start"><a href="../customers/index.php?cmd=list"><i class="icon-rocket"></i>Customers</a></li>
                <li class="start"><a href="../product/index.php?cmd=list"><i class="icon-rocket"></i>product</a></li>
               <?php
				  }
				?>  
                <li class="start"><a href="../invoice/index.php?cmd=list"><i class="icon-rocket"></i>Invoice</a></li>
