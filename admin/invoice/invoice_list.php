...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","invoice"))?></a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("invoice");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_invoice" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['total_cost']?></td>
                              <td><?=$arr[$i]['amount_paid']?></td>
							  <td nowrap >
                                  ...
                                  <a href="index.php?cmd=print&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Print</a> 
							      <a  href="javascript:void();"  onClick="popUp('index.php?cmd=details&id=<?=$arr[$i]['id']?>')" class="btn blue button-next">
                                           Details
