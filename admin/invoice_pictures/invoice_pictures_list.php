...
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","invoice_pictures"))?></a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("invoice_pictures");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_invoice_pictures" >
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                                ...
                                <?php
                                    ...
                                    $info2['table']    = "invoice";	
                                    $info2['fields']   = array("*");	   	   
                                    $info2['where']    =  "1 AND id='".$arr[$i]['invoice_id']."' LIMIT 0,1";
                                ...
                                <td>  
								   <?php
                                    if(is_file('../../'.$arr[$i]['file_picture'])
                                        && file_exists('../../'.$arr[$i]['file_picture']))
                                        {
                                    ?>
